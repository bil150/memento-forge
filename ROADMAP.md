...
- [ ] Support multilingue (locale FR/EN)
- [ ] Base de données SQLite pour stocker les entrées (au lieu du HTML statique)
- [ ] Interface permettant de créer son propre mémento personnalisé

## Fait

- [x] Extraction du CSS commun dans `css/memento.css`
- [x] Renommage des fichiers en norme HTML (minuscules, tirets)
